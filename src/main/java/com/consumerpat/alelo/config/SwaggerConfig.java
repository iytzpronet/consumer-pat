package com.consumerpat.alelo.config;
    ...
    public OpenAPI springBlogpessoalOpenAPI() { //Cria um Objeto da Classe OpenAPI, que gera a documentação no Swagger utilizando a especificação OpenAPI.
        return new OpenAPI()
                ...
                //Insere as informações sobre a API (Nome do projeto (Title), Descrição e Versão, Licença, Links, E-mails, e contatos.)
                                .info(new Info()
                                .title("Consumer-Pat")
                                .description("Consumer-pat - by: Matheus")
                                .version("1.0")
                                .license(new License()
                                .name("Alelo")
                                .url("https://github.com/iytzpronet"))
                                .contact(new Contact().name("matheus")
                                .email("matheusfsa95@hotmail.com").url("https://github.com/iytzpronet")))
